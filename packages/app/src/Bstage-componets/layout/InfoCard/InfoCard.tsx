...
export function InfoCard(props: Props): JSX.Element {
  ...
  return (
    <Card style={{...calculatedStyle, ...{boxShadow: '0px 8px 15px rgba(0, 0, 0, 0.1)'}, ...customStyle}} className={className}>
      <ErrorBoundary {...errProps}>
        {title && (
          <CardHeader
            ...
            action={action}
            style={{ ...headerStyle, backgroundColor: colors.PRIMARY_TEXT_COLOR }}
        ...
        <CardContent
          ...
          style={{...calculatedCardStyle, backgroundColor: colors.BACKGROUND_COLOR, color: colors.PRIMARY_TEXT_COLOR, ...cardStyle}}
        >
          {children}
        </CardContent>
        {actions && (
