...
const useStyles = makeStyles<BackstageTheme>(
  theme => ({
    header: {
      ...
      flexDirection: 'row',
      alignItems: 'center',
      backgroundImage: 'url("https://e0.pxfuel.com/wallpapers/379/433/desktop-wallpaper-black-red-amoled-neon-samsung-material-modern-texture-design-pattern-abstract-galaxy-smooth-ultra-thumbnail.jpg")',
...
const TypeFragment = ({
  ...
  if (!typeLink) {
    return <Typography style={{color: colors.PRIMARY_TEXT_COLOR}} className={classes.type}>{type}</Typography>;
  }
...
export function Header(props: PropsWithChildren<Props>) {
  ...
  return (
    <>
      ...
      <header style={{background: colors.BACKGROUND_COLOR}} className={classes.header}>
