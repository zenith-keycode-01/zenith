...
export function HeaderTabs(props: HeaderTabsProps) {
  ...
  return (
    <Box style={{backgroundColor: colors.BACKGROUND_COLOR}} className={styles.tabsWrapper}>
    <Box style={{backgroundColor: colors.PRIMARY_TEXT_COLOR, paddingLeft: '10px',marginRight: '24px', borderRadius: '10px'}}>
      <Tabs
