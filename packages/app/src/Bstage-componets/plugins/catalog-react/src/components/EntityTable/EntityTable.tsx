...
import { Table, TableColumn, TableOptions } from '../../../../../components';
...
export const EntityTable = <T extends Entity>(props: EntityTableProps<T>) => {
  ...
  return (
    <Table<T>
      columns={columns}
      title={<Typography style={{color: colors.WHITE, fontSize: 24, fontWeight: 600}}>{title}</Typography>}
      style={{...tableStyle, ...{background: colors.PRIMARY_TEXT_COLOR}}}
      emptyContent={
