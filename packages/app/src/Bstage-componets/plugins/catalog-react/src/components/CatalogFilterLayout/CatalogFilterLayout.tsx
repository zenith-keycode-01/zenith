...
export const Filters = (props: {
  ...
  return isScreenSmallerThanBreakpoint ? (
    ...
    <Grid item xs={12} lg={12} style={{background: 'white', borderRadius: 20, marginLeft: '45px', marginRight: '45px', display: 'flex',boxShadow: '0px 8px 15px rgba(0, 0, 0, 0.2)', flexDirection: 'row'}} >
      {props.children}
    </Grid>
  );
};
