...
export const ProviderSettingsItem = (props: {
  ...
  return (
    <ListItem>
      ...
      <ListItemText
        primary={<Typography style={{color: colors.PRIMARY_TEXT_COLOR, fontWeight: 600}}>{title}</Typography>}
        disableTypography
        secondary={
            ...
            <Grid container spacing={6}>
              ...
              <Grid item xs={12} sm container>
                <Grid item xs container direction="column" spacing={2}>
                  <Grid item xs>
                    <Typography
                     style={{color: colors.PRIMARY_TEXT_COLOR, fontWeight: 500}}
                      variant="subtitle1"
                      color="textPrimary"
                      gutterBottom
                    >
                    ...
                    <Typography style={{color: colors.PRIMARY_TEXT_COLOR, fontWeight: 500}} variant="body2">
                      {profile.email}
                    </Typography>
                    <Typography style={{color: colors.PRIMARY_TEXT_COLOR, fontWeight: 500}} variant="body2">
                      {description}
