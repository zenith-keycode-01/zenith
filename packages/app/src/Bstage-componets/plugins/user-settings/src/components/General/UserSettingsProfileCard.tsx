      ...
      <Grid container spacing={6}>
        ...
        <Grid item xs={12} sm container>
          <Grid item xs container direction="column" spacing={2}>
            <Grid item xs>
              <Typography style={{ color: colors.PRIMARY_TEXT_COLOR, fontWeight: 500, fontSize: '20px' }} variant="subtitle1" gutterBottom>
                {displayName}
              </Typography>
              {profile.email && (
                <Typography style={{ color: colors.PRIMARY_TEXT_COLOR, fontWeight: 500 }} variant="body2" color="textSecondary">
                  {profile.email}
                </Typography>
              )}
            </Grid>
