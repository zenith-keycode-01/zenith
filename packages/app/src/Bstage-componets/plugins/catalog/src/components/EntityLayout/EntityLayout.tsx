...
import { Content, Header, HeaderLabel, Page } from '../../../../../layout';
import { Link, Progress, RoutedTabs, WarningPanel } from '../../../../../components';
  ...
  return (
    <Page themeId={entity?.spec?.type?.toString() ?? 'home'}>
      <Header
        ...
        type={headerType}
        style={{background: colors.BACKGROUND_COLOR, color: colors.PRIMARY_TEXT_COLOR}}
      >
        {entity && (
          <>
