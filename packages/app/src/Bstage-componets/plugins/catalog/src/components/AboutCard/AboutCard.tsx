...
import ViewSource from '@material-ui/icons/UnfoldMore';
import { isTemplateEntityV1beta3 } from '@backstage/plugin-scaffolder-common';
import { parseEntityRef } from '@backstage/catalog-model';
import { InfoCardVariants } from '../../../../../layout';
import { HeaderIconLinkRow, IconLinkVerticalProps, Link } from '../../../../../components';
...
export function AboutCard(props: AboutCardProps) {
  ...
  const viewInSource: IconLinkVerticalProps = {
    ...
    icon: <ViewSource style={{transform: 'rotate(90deg)', color: colors.WHITE}}/>,
  ...
  const viewInTechDocs: IconLinkVerticalProps = {
    ...
    icon: <DocsIcon style={{color: colors.WHITE}}  />,
    href:
      viewTechdocLink &&
      (techdocsRef
        ? viewTechdocLink({
  ...
  return (
    <Card style={{background: colors.WHITE, boxShadow:'0px 8px 15px rgba(0, 0, 0, 0.2)',  color: '#696880'}} className={cardClass}>
      <CardHeader
        title="About"
        style={{color: colors.WHITE, backgroundColor: colors.PRIMARY_TEXT_COLOR, fontFamily: 'Catamaran'}}
        action={
          <>
            {allowRefresh && (
              <IconButton
              ...
              >
                <CachedIcon style={{color: colors.WHITE}}  />
              </IconButton>
            )}
            <IconButton
              component={Link}
