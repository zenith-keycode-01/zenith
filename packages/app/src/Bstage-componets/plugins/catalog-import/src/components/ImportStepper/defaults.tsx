      ...
      return {
        ...
        prepare: () => ({
          stepLabel: (
            <StepLabel
              optional={
                <Typography style={{color: colors.PRIMARY_TEXT_COLOR}} variant="caption">
...
const textStyle = {color: colors.PRIMARY_TEXT_COLOR, fontWeight: 600}

export const defaultStepper: StepperProvider = {
  analyze: (state, { apis }) => ({
    stepLabel: <Typography style={textStyle}>  1 Select URL</Typography>,
    content: (
      <StepInitAnalyzeUrl
        key="analyze"
  ...
  prepare: state => ({
    stepLabel: <Typography style={textStyle}>  2 Import Actions</Typography>,
    content: <BackButton onClick={state.onGoBack} />,
  }),

  review: state => ({
    stepLabel: <Typography style={textStyle}>  3 Review</Typography>,
    content: (
      <StepReviewLocation
        prepareResult={state.prepareResult}
  ...
  finish: state => ({
    stepLabel: <Typography style={textStyle}>  4 Finish</Typography>,
    content: (
