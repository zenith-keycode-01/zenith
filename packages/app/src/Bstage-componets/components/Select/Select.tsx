      ...
      <FormControl className={classes.formControl}>
        ...
        <Select
          ...
          renderValue={s =>
            multiple && (value as any[]).length !== 0 ? (
              ...
              <Typography style={{color: colors.PRIMARY_COLOR_1, fontFamily: 'Catamaran'}}>
        ...
        >
          ...
          {native
            ...
            : items &&
     items.map(item => (
                <MenuItem style={{color: colors.PRIMARY_COLOR_1, fontFamily: 'Catamaran'}} key={item.value} value={item.value}>
                  {multiple && (
                    <Checkbox
                      color="primary"
